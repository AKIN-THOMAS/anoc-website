      ...
      <section id="stats" className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
          <div>
            ...
            <p className="text-slate-600 mt-2">Years of Professional Excellence</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-orange-500">100+</h3>
            <p className="text-slate-600 mt-2">Clients Served Nationwide</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-orange-500">6</h3>
            <p className="text-slate-600 mt-2">Partners</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-orange-500">4</h3>
            <p className="text-slate-600 mt-2">Offices Across Nigeria</p>
          </div>
        </div>
      </section>
